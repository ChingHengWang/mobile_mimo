...
namespace variant_msgs
{
  ...
  class Test : public ros::Msg
  {
    public:
      ...
      int32_t st_builtin_int_vector;
      int32_t * builtin_int_vector;
      std_msgs::String string_array[3];
      uint32_t string_vector_length;
      std_msgs::String st_string_vector;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (u_builtin_boolean.base >> (8 * 0)) & 0xFF;
      ...
      memcpy(outbuffer + offset, &length_builtin_string, sizeof(uint32_t));
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      memcpy(&length_builtin_string, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
