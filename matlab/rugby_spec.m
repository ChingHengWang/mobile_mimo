...
% project name 
% matlab_ws > andbot > prototype > mobile > motor > calculation > rugby.m


% content: 
% calcualte rugby robot motor specification
...
l=0.234; %meter  wheel seperation
%r=0.048*2; %meter radius of wheel
r=0.0625
...
m_wheel=0.150; % mass of one wheel @design by mech team
I=m_wheel*r^2 % rough calculate Inertia of one wheel 

m=10;%kg

u=0.4; % assumption between metal and wood
% not used now, we don't consider skid situation
