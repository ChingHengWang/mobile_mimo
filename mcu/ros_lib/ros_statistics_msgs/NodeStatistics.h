...
namespace ros_statistics_msgs
{
  ...
  class NodeStatistics : public ros::Msg
  {
    public:
      ...
      float cpu_load_std;
      float cpu_load_max;
      double virt_mem_mean;
      float virt_mem_std;
      double virt_mem_max;
      double real_mem_mean;
      float real_mem_std;
      double real_mem_max;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_cpu_load_max.base >> (8 * 3)) & 0xFF;
      ...
      u_virt_mem_mean.real = this->virt_mem_mean;
      *(outbuffer + offset + 0) = (u_virt_mem_mean.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_virt_mem_mean.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_virt_mem_mean.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_virt_mem_mean.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_virt_mem_mean.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_virt_mem_mean.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_virt_mem_mean.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_virt_mem_mean.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->virt_mem_mean);
      union {
        float real;
        uint32_t base;
      } u_virt_mem_std;
      ...
      *(outbuffer + offset + 3) = (u_virt_mem_std.base >> (8 * 3)) & 0xFF;
      ...
      u_virt_mem_max.real = this->virt_mem_max;
      *(outbuffer + offset + 0) = (u_virt_mem_max.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_virt_mem_max.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_virt_mem_max.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_virt_mem_max.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_virt_mem_max.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_virt_mem_max.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_virt_mem_max.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_virt_mem_max.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->virt_mem_max);
      union {
        double real;
        uint64_t base;
      } u_real_mem_mean;
      u_real_mem_mean.real = this->real_mem_mean;
      *(outbuffer + offset + 0) = (u_real_mem_mean.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_real_mem_mean.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_real_mem_mean.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_real_mem_mean.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_real_mem_mean.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_real_mem_mean.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_real_mem_mean.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_real_mem_mean.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->real_mem_mean);
      union {
        float real;
        uint32_t base;
      } u_real_mem_std;
      ...
      *(outbuffer + offset + 3) = (u_real_mem_std.base >> (8 * 3)) & 0xFF;
      ...
      u_real_mem_max.real = this->real_mem_max;
      *(outbuffer + offset + 0) = (u_real_mem_max.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_real_mem_max.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_real_mem_max.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_real_mem_max.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_real_mem_max.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_real_mem_max.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_real_mem_max.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_real_mem_max.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->real_mem_max);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_virt_mem_mean.base = 0;
      u_virt_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_virt_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_virt_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_virt_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_virt_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_virt_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_virt_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_virt_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->virt_mem_mean = u_virt_mem_mean.real;
      offset += sizeof(this->virt_mem_mean);
      union {
        float real;
        uint32_t base;
      ...
      u_virt_mem_max.base = 0;
      u_virt_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_virt_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_virt_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_virt_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_virt_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_virt_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_virt_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_virt_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->virt_mem_max = u_virt_mem_max.real;
      offset += sizeof(this->virt_mem_max);
      union {
        double real;
        uint64_t base;
      } u_real_mem_mean;
      u_real_mem_mean.base = 0;
      u_real_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_real_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_real_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_real_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_real_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_real_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_real_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_real_mem_mean.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->real_mem_mean = u_real_mem_mean.real;
      offset += sizeof(this->real_mem_mean);
      union {
        float real;
        uint32_t base;
      ...
      u_real_mem_max.base = 0;
      u_real_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_real_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_real_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_real_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_real_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_real_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_real_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_real_mem_max.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->real_mem_max = u_real_mem_max.real;
      offset += sizeof(this->real_mem_max);
     return offset;
    }
