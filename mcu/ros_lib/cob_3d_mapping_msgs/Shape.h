...
namespace cob_3d_mapping_msgs
{
  ...
  class Shape : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 4) = (u_paramsi.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_paramsi.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_paramsi.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_paramsi.base >> (8 * 7)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(params_lengthT > params_length)
        this->params = (double*)realloc(this->params, params_lengthT * sizeof(double));
      ...
      u_st_params.base = 0;
      u_st_params.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_params.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_params.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_params.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_st_params.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_st_params.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_st_params.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_st_params.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->st_params = u_st_params.real;
      offset += sizeof(this->st_params);
        memcpy( &(this->params[i]), &(this->st_params), sizeof(double));
      }
